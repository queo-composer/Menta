            ...
            try {
                ...
                if ($previousPath && is_file($previousScreenshot)) {
                    if (md5_file($directory . DIRECTORY_SEPARATOR . $fileName) != md5_file($previousScreenshot)) {
                        ...
                        link(
                            $previousPath . DIRECTORY_SEPARATOR . $thumbnailName,
                            $directory . DIRECTORY_SEPARATOR . $thumbnailNamePrev
                        );

                        $result .= '<a class="previous" title="' . $screenshot->getTitle(
                            ) . '" href="' . $fileNamePrev . '">';
                        ...
                        $result .= '<a class="current" title="' . $screenshot->getTitle(
                            ) . '" href="' . $fileNameDiff . '">';
